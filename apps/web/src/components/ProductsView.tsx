      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-xs text-slate-400">
            Manage seller inventory catalog, SKUs, and specifications
          </p>
        </div>
        <button
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <h4 className="text-lg font-bold text-white font-outfit mt-2">
                    {product.name}
                  </h4>
              ...
              <div className="border-t border-white/5 pt-3 grid grid-cols-2 gap-y-2 gap-x-4 text-xs text-slate-350">
                ...
                {product.barcode && (
                  <div className="flex items-center gap-1.5 col-span-2">
                    ...
                    <span>
                      Barcode:{" "}
                      <code className="text-slate-300 font-mono font-bold bg-slate-900/60 px-1.5 py-0.5 rounded">
                        {product.barcode}
                      </code>
                    </span>
                  </div>
