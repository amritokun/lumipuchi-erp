...
class Order(Base):
    ...
    channel_order_id = Column(String, unique=True, index=True, nullable=False) # e.g. "AZ-100234"
    channel_name = Column(String, nullable=False, index=True) # Amazon Easy Ship, Flipkart, Meesho, etc.
    customer_name = Column(String, nullable=True)
    status = Column(String, default="pending", nullable=False) # pending, shipped, delivered, returned, cancelled
